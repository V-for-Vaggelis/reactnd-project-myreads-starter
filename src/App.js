        ...
        {this.state.showSearchPage ? (
          ...
          <div className="list-books">
            ...
            <div className="list-books-content">
              <div>
                <ShelfDisplay shelfName="Currently reading" books={this.state.books.filter((book) => book.status === "currentlyReading")} />
                <ShelfDisplay shelfName="Want to read" books={this.state.books.filter((book) => book.status === "wantToRead")} />
                <ShelfDisplay shelfName="Read" books={this.state.books.filter((book) => book.status === "read")} />
              </div>
            </div>
